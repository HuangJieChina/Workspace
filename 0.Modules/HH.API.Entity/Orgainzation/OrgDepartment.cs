...
namespace HH.API.Entity.Orgainzation
{
    ...
    /// </summary>
    [Serializable]
    [Table(EntityConfig.Table.OrgDepartment)]
    public class OrgDepartment : OrgUnit
    {
        /// <summary>
        /// 根节点
        /// </summary>
        ...
        /// 获取当前组织对象类型：组织单元
        /// </summary>
        public override UnitType UnitType => UnitType.OrgDepartment;
        ...
        public override string TableName
        {
            get
            {
                return EntityConfig.Table.OrgDepartment;
            }
        }
    }
    ...
    /// 组织保护级别
    /// </summary>
    public enum DepartmentProtectionLevel
    {
        /// <summary>
        /// 对所有人开放
        /// </summary>
